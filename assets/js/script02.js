...
// Weitere Funktionen
        ...
        function updateAnnotationOpacity() {
            var meshDistance = camera.position.distanceTo(sprite.position);
        ...
        function updateScreenPosition() {
            var vector = new THREE.Vector3(0.5, 0.1, 0);
            var canvas = renderer.domElement; // `renderer` is a THREE.WebGLRenderer
